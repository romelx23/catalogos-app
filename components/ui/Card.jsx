...
function Card({ card }) {
  ...
  return (
    <div className="card bg-dark text-white border-0 md:w-72 w-52 bg-gray-700/80">
      <div className="">
        <img
          src={card.img}
          className="object-cover object-center block m-auto h-72 md:h-96 opacity-75 hover:opacity-100 transition-all duration-500 shadow-xl"
          alt="catálogo"
          title={card.title}
        />
      </div>
      ...
      <button
        className="btn w-full flex justify-center gap-1 mt-2"
